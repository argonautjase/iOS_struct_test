...
//        navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .done, target: self, action: #selector(handleDone))
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let x = (JobRoleCategory(rawValue: indexPath.row)!.jobRoleType)
        print("X is \(x)")
//        userModel.jobCategory = "boo"
//        print("here it is \(userModel.jobCategory)")
////        userModel?.jobCategory = (JobRoleCategory(rawValue: indexPath.row)!.jobRoleType)
//        print("usermodel jobcategory = \(userModel?.jobCategory)")
    }
}
